...
import com.carissa.intermediate.DataDummy
import com.carissa.intermediate.MainDispatcherRule
...
import com.carissa.intermediate.getOrAwaitValue
...
class MainViewModelTest{
    ...
    fun `when Get Story Should Not Null and Return Data`() = runTest {
        val token = "token_authentication"
        ...
        val actualStory: PagingData<ListStoryItem> = mainViewModel.getAllStoryPaging(token).getOrAwaitValue()
